...
public class HelloWorldClientHandler extends ChannelInboundHandlerAdapter {
        ...
        public void channelActive(ChannelHandlerContext ctx) {
            ...
            if (nChannel == null) {
                System.out.println("HelloWorldClientHandler channelActive attributeMap 中是没有值的" + this.getClass());
                NettyChannel newNChannel = new NettyChannel("HelloWorld0Client", new Date());
                nChannel = attr.setIfAbsent(newNChannel);
            } else {
                System.out.println("HelloWorldClientHandler channelActive attributeMap 中是有值的"+ this.getClass());
